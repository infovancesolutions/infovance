...
const ServicesSection: React.FC = () => {
  return (
    <section className="w-full py-20 px-6 md:px-16 bg-transparent font-inter">
      {/* Section Header */}
      <div className="text-center mb-14">
        <ScrollAnimation delay={100}>
          <h4 className="text-orange-600 font-bold uppercase tracking-widest">
            What We Do
          </h4>
        </ScrollAnimation>

        <ScrollAnimation delay={150}>
          <h2 className="text-3xl md:text-5xl font-bold text-orange-900 mt-3 leading-tight">
